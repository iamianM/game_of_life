...
contract Canvas {
    ...
    uint  internal kHead = 1;
    uint  internal numCells = 4**kHead;
    uint  internal lastUpdatedBlock;
    uint  internal blocksToWait; 

    mapping(uint => Node)  internal hashToNode;
    ...
    function join(Node memory a, Node memory b, Node memory c, Node memory d) internal returns(Node memory) {
        /*
    ...
    function getXandY(Node memory node, uint x, uint y)  internal view returns(string memory) {
        uint k = node.k;
    ...
    function activateNode(Node memory node, uint[] memory segments, uint j)   internal returns(Node memory) {
    ...
    function get_zero(uint k)   internal returns(Node memory) {
        /*
    ...
    function centre(Node memory m)  internal returns(Node memory){
        /*
    ...
    function life(ns9 memory temp)   internal returns(Node memory) {
        /*
    ...
    function life_4x4(Node memory m)   internal returns(Node memory){
        /*
        """
    ...
    function successor(Node memory m, uint j)  internal returns(Node memory) {
        /*
        """
    ...
    // function successor(Node memory m, uint j, bool[4] edges)   internal returns(Node memory) {
    //     /*
    //     """
    //     Return the 2**k-1 x 2**k-1 successor, 2**j generations in the future, 
    //     where j <= k - 2, caching the result.
    ...
    // function pad(Node memory node)   internal returns(Node memory) {
    //     /*
    //     """
    ...
    // function min(Point[] memory pts)   internal pure returns (uint256, uint256) {
    //     uint i = 0;
    ...
    function ffwd(Node memory node, uint n)  internal returns(Node memory) {
        /*
    ...
    function inner(Node memory node)   internal returns(Node memory) {
        /*
        """
    ...
    function advance(Node memory node, uint n) internal returns(Node memory) {
        /*
    ...
    function print(Node memory node) internal view returns(string memory) {
        if (node.k == 0) {
            if (node.n == 0) {
                return '.';
            } else {
    ...
    // function print_node(node)  internal view returns(string memory) {
    //     /*
    //     """
